...
GM.registerMenuCommand(SCRIPT_NAME + ': set ad close delay', function () {
...
GM.registerMenuCommand(SCRIPT_NAME + ': ' + (MUTE_AD ? 'disable' : 'enable') + ' video ad muting (warning clicking this will refresh the page)', function () {
  Util.storeSet('MUTE_AD', !MUTE_AD);
  location.reload();
});
GM.registerMenuCommand(SCRIPT_NAME + ': ' + (HIDE_AD ? 'disable' : 'enable') + ' video ad hiding (warning clicking this will refresh the page)', function () {
